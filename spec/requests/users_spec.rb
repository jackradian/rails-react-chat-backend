...
RSpec.describe "Users", type: :request do
  ...
  let(:data_with_blank_email) {
    data = valid_data
    data["email"] = nil
    data
  }
  let(:data_with_blank_password) {
    data = valid_data
    data["password"] = nil
    data
  }
  let(:data_with_short_password) {
    data = valid_data
    data["password"] = "1" * 5
    data
  }
  let(:data_with_long_password) {
    data = valid_data
    data["password"] = "1" * 129
    data
  }
  let(:data_with_blank_nickname) {
    data = valid_data
    data["nickname"] = nil
    data
  }
  let(:data_with_blank_first_name) {
    data = valid_data
    data["first_name"] = nil
    data
  }
  let(:data_with_blank_last_name) {
    data = valid_data
    data["last_name"] = nil
    data
  }
