  ...
  describe "GET /my_direct_rooms" do
    ...
    context "when have rooms" do
      it "response with rooms array and their participants and messages" do
        ...
        room_1 = FactoryBot.create(:room, :with_ten_direct_messages_of_two_users, participant_1: user, participant_2: friend_1)
        room_2 = FactoryBot.create(:room, :with_ten_direct_messages_of_two_users, participant_1: user, participant_2: friend_2)
        ...
        expected_data = Jbuilder.encode do |json|
          json.err(0)
          json.rooms(expected_rooms) do |room|
            json.id(room.id)
